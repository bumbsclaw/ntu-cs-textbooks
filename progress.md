...
| Phase | Status | Notes |
|-------|--------|-------|
| 0 - Curriculum deep research and outline | IN_PROGRESS | Official NTU CCDS plus public forums |
| 0a - Adversarial review of outline | PENDING | |
...
|------|-------|----|------|---------|-------|-------------|----|-----|
| SC2001 | Algorithm Design and Analysis | 3 | Core | pending | pending | pending | pending | pending |
