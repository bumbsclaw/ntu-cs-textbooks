...
| 2 - Batch expansion (3 cores) | READY | queued: SC1007, SC2005, SC2006 — chunked writers awaiting go |
...
|------|-------|----|------|---------|-------|-------------|----|-----|
| SC2001 | Algorithm Design and Analysis | 3 | Core | DONE (ab1d8cd) | DONE v2 8/8 (1859→~1870 lines, 16 TikZ color) 01:44 SGT | DONE PASS v2 ch01-04 (REVIEW-v2-ch01-04.md) + PASS v2 ch05-08 (REVIEW-v2-ch05-08.md) 01:47 SGT | DONE | DONE v2 45p 880KB (0 !, 0 pgfkeys, 0 Overfull>15pt, 0 hyperref) |
