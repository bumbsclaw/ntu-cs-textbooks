...
\title{SC4013 Application Security\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-owasp}
\include{chapters/ch02-auth}
\include{chapters/ch03-injection}
\include{chapters/ch04-access}
\include{chapters/ch05-crypto}
\include{chapters/ch06-api-client}
\include{chapters/ch07-ssrf-http}
\include{chapters/ch08-sdlc}
\backmatter
\end{document}
