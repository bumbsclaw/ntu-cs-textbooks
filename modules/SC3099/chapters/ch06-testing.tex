...
{\sloppy Unit tests mock collaborators; \emph{integration tests} restore them to verify contracts. Test the seams: controller$\leftrightarrow$service, service$\leftrightarrow$repository, and app$\leftrightarrow$external API (with a sandbox or recorded fixture, not live production).\par}
