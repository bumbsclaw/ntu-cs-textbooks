...
\paragraph{Requirements coverage.} Build a table: each Req~ID to test~ID to
...
sign-off) rather than hidden. Link to the traceability matrix (Ch.~2) so a marker can audit.
