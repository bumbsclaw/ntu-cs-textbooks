...
\title{SC2207 Introduction to Databases\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-models}
\include{chapters/ch02-relational}
\include{chapters/ch03-sql}
\include{chapters/ch04-normalization}
\include{chapters/ch05-storage}
\include{chapters/ch06-query}
\include{chapters/ch07-transactions}
\include{chapters/ch08-advanced}
\backmatter
\end{document}
