...
\title{SC1008 C/C++ Programming\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-c-basics}
\include{chapters/ch02-pointers-memory}
\include{chapters/ch03-arrays-strings-structs}
\include{chapters/ch04-dynamic-memory}
\include{chapters/ch05-cpp-classes-oop}
\include{chapters/ch06-inheritance-polymorphism-templates}
\include{chapters/ch07-stl}
\include{chapters/ch08-modern-cpp}
\backmatter
\end{document}
