...
\title{SC2002 Object-Oriented Design \& Programming\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-objects}
\include{chapters/ch02-classes}
\include{chapters/ch03-inheritance}
\include{chapters/ch04-uml}
\include{chapters/ch05-solid}
\include{chapters/ch06-patterns}
\include{chapters/ch07-exceptions-generics}
\include{chapters/ch08-testing}
\backmatter
\end{document}
