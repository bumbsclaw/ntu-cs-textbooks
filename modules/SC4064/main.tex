...
\usepackage{xcolor}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,calc,shapes,shapes.geometric,decorations.pathreplacing,decorations.pathmorphing,fit,backgrounds,trees,automata,shadows}
\usepackage{listings}
\usepackage{hyperref}
...
\title{SC4064 GPU Programming\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\include{chapters/ch02-cuda}
\include{chapters/ch03-memory}
\include{chapters/ch04-optimization}
\include{chapters/ch05-libraries}
\include{chapters/ch06-multi}
\include{chapters/ch07-profiling}
