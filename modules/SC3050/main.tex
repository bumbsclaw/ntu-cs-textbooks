...
\title{SC3050 Advanced Computer Architecture\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-review}
\include{chapters/ch02-superscalar}
\include{chapters/ch03-branch}
\include{chapters/ch04-memory-advanced}
\include{chapters/ch05-interconnect}
\include{chapters/ch06-accelerators}
\include{chapters/ch07-parallel}
\include{chapters/ch08-performance}
\backmatter
\end{document}
