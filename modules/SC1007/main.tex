...
\title{SC1007 Data Structures \& Algorithms\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-stl-foundations}
\include{chapters/ch02-stacks-queues}
\include{chapters/ch03-trees-traversals}
\include{chapters/ch04-bst-balanced}
\include{chapters/ch05-heaps-priority}
\include{chapters/ch06-hashing}
\include{chapters/ch07-graphs}
\include{chapters/ch08-graphs-sorting}
\backmatter
\end{document}
