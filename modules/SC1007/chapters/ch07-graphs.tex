...
\textbf{Minimum Spanning Tree (MST):} cheapest set of $n-1$ edges connecting all vertices. Kruskal sorts edges and union-finds; Prim grows via min-heap (Ch.~5): both $O(m\log n)$.
