\chapter{\texorpdfstring{Foundations: Tokens, Zipf, and $n$-Grams}{Foundations: Tokens, Zipf, and n-Grams}}\label{ch:foundations}
...
\textbf{From zero: no NLP background assumed.} We start from raw bytes and ask how to slice text into tokens, why word frequencies follow Zipf's law, and how $n$-grams predict the next word. Every formula is motivated by a picture first.}}
\vspace{0.3em}
\section*{Learning Outcomes}
After this chapter you will be able to:
\begin{enumerate}[label=(L\arabic*)]
    \item distinguish tokens, types, and vocabulary and run word versus subword (BPE) tokenization;
    \item state Zipf's law and explain its consequences for vocabulary and OOV;
    \item write the $n$-gram MLE and explain why sparsity demands smoothing;
    \item implement tokenization and BPE counting in Python.
\end{enumerate}
...
\section{\texorpdfstring{$n$-Grams: Predicting the Next Token}{n-Grams: Predicting the Next Token}}
