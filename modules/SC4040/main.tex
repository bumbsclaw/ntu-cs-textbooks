...
\title{SC4040 Advanced Topics in Algorithms\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
\author{NTU CS Curriculum Textbook Series\\College of Computing and Data Science}
\date{2026-08-28 --- Generated for ntu-cs-textbooks}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-approximation}
\include{chapters/ch02-randomization}
\include{chapters/ch03-online}
\include{chapters/ch04-parameterized}
\include{chapters/ch05-spectral}
\include{chapters/ch06-string-advanced}
\include{chapters/ch07-geometry}
\include{chapters/ch08-lowerbounds}
\backmatter
\end{document}
