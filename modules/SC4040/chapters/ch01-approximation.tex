...
% ============================================================
\section{\texorpdfstring{Vertex Cover: A $2$-Approximation from Maximal Matching}{Vertex Cover: A 2-Approximation from Maximal Matching}}
...
% ============================================================
\section{\texorpdfstring{Set Cover: Greedy $\ln n$ and Its Limit}{Set Cover: Greedy ln n and Its Limit}}
\label{sec:set-cover}
