...
\usepackage{xcolor}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,calc,shapes,shapes.geometric,decorations.pathreplacing,fit,backgrounds,automata}
\usepackage{listings}
\usepackage{hyperref}
...
\title{SC2005 Operating Systems\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\include{chapters/ch02-processes}
\include{chapters/ch03-scheduling}
\include{chapters/ch04-synchronization}
\include{chapters/ch05-deadlocks}
\include{chapters/ch06-memory}
\include{chapters/ch07-virtual-memory}
\include{chapters/ch08-filesec}
\backmatter
\end{document}
