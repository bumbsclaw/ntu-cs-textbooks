...
\title{SC2006 Software Engineering\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-sdlc}
\include{chapters/ch02-requirements}
\include{chapters/ch03-uml}
\include{chapters/ch04-design-principles}
\include{chapters/ch05-implementation-vcs}
\include{chapters/ch06-testing}
\include{chapters/ch07-maintenance}
\include{chapters/ch08-agile}
\backmatter
\end{document}
