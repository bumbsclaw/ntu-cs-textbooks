...
\title{SC4001 Neural Networks \& Deep Learning\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-perceptron}
\include{chapters/ch02-mlp}
\include{chapters/ch03-optimization}
\include{chapters/ch04-regularization}
\include{chapters/ch05-cnn}
\include{chapters/ch06-rnn}
\include{chapters/ch07-transformer}
\include{chapters/ch08-training}
\backmatter
\end{document}
