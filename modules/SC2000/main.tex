...
\usepackage{xcolor}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,calc,shapes,shapes.geometric,decorations.pathreplacing,fit,backgrounds,trees,patterns}
\usepackage{listings}
\usepackage{hyperref}
...
\title{SC2000 Probability \& Statistics for Computing\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-counting}
\include{chapters/ch02-samplespaces}
\include{chapters/ch03-conditional}
\include{chapters/ch04-distributions}
\include{chapters/ch05-expectation}
\include{chapters/ch06-joint}
\include{chapters/ch07-estimation}
\include{chapters/ch08-hypothesis}
\backmatter
\end{document}
