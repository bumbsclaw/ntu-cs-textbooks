...
\title{SC4012 Software Security\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-threat}
\include{chapters/ch02-memory}
\include{chapters/ch03-web}
\include{chapters/ch04-crypto-misuse}
\include{chapters/ch05-fuzzing}
\include{chapters/ch06-verification}
\include{chapters/ch07-malware}
\include{chapters/ch08-secure-dev}
\backmatter
\end{document}
