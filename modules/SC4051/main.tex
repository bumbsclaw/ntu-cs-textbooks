...
\title{SC4051 Distributed Systems\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\include{chapters/ch02-time}
\include{chapters/ch03-rpc}
\include{chapters/ch04-consensus}
\include{chapters/ch05-replication}
\include{chapters/ch06-storage}
\include{chapters/ch07-transactions}
\include{chapters/ch08-case-studies}
\backmatter
\end{document}
