...
\begin{tikzpicture}[scale=0.85, every node/.style={font=\footnotesize}]
  ...
  \node at (4,-0.3) {$B$};
  \draw[->,thick,violet!70!black] (5.3,1) -- (6.2,1) node[midway,above,violet!70!black] {$7\times$};
  \node[draw,rounded corners,align=center,fill=violet!8] at (8,1) {$M_1\dots M_7$\\$n/2\times n/2$ products\\$+\;18$ additions $\Theta(n^2)$};
