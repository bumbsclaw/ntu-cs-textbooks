...
\end{quote}
\noindent\textbf{Prerequisites:} Asymptotic notation (Ch.~2), exchange arguments and induction (Ch.~1), priority queues (heaps; SC1007 Ch.~5) and Union-Find (disjoint-set union; SC1007 Ch.~7), basic graph terminology (Ch.~6 preview).
