...
\title{SC3010 Computer Security\\NTU BSc Computer Science — Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-foundation}
\include{chapters/ch02-crypto}
\include{chapters/ch03-auth}
\include{chapters/ch04-access}
\include{chapters/ch05-software}
\include{chapters/ch06-network}
\include{chapters/ch07-os}
