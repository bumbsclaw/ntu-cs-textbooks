...
\title{SC2203 Automata, Computability \& Complexity\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-alphabets}
\include{chapters/ch02-regular}
\include{chapters/ch03-regular-properties}
\include{chapters/ch04-contextfree}
\include{chapters/ch05-pushdown}
\include{chapters/ch06-turing}
\include{chapters/ch07-decidability}
\include{chapters/ch08-complexity}
\backmatter
\end{document}
