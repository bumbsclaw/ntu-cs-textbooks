...
\title{SC3270 Reasoning About Programs\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-hoare-intro}
\include{chapters/ch02-prepost}
\include{chapters/ch03-invariants}
\include{chapters/ch04-loop-verification}
\include{chapters/ch05-termination}
\include{chapters/ch06-weakest-pre}
\include{chapters/ch07-separation}
\include{chapters/ch08-refinement}
\backmatter
\end{document}
