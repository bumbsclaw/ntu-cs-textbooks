...
\usepackage{xcolor}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,calc,shapes,shapes.geometric,decorations.pathreplacing,decorations.pathmorphing,fit,backgrounds,trees,automata,shadows,3d}
\usepackage{listings}
\usepackage{hyperref}
...
\title{SC4055 Introduction to Quantum Computing\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-qubit}
\include{chapters/ch02-circuits}
\include{chapters/ch03-deutsch}
\include{chapters/ch04-grover}
\include{chapters/ch05-shor}
\include{chapters/ch06-noise}
\include{chapters/ch07-complexity}
