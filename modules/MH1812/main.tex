...
\title{MH1812 Discrete Mathematics\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-logic}
\include{chapters/ch02-sets}
\include{chapters/ch03-functions}
\include{chapters/ch04-proof}
\include{chapters/ch05-counting}
\include{chapters/ch06-recurrence}
\include{chapters/ch07-graphs}
\include{chapters/ch08-numbertheory}
\backmatter
\end{document}
