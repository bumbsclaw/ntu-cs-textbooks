...
\usepackage{xcolor}
\usepackage{tikz}
\usetikzlibrary{arrows.meta,positioning,calc,shapes,shapes.geometric,decorations.pathreplacing,fit,backgrounds,trees,patterns,automata}
\usepackage{listings}
\usepackage{hyperref}
...
\title{SC4021 Information Retrieval\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\include{chapters/ch02-boolean-vector}
\include{chapters/ch03-tfidf}
\include{chapters/ch04-index}
\include{chapters/ch05-evaluation}
\include{chapters/ch06-expansion}
\include{chapters/ch07-pagerank}
\include{chapters/ch08-neural}
\backmatter
\end{document}
