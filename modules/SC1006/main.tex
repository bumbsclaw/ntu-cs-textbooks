...
\title{SC1006 Computer Organisation \& Architecture\\NTU BSc Computer Science --- Comprehensive Textbook (0--100)}
...
\tableofcontents
\mainmatter
\include{chapters/ch01-isa}
\include{chapters/ch02-datapath}
\include{chapters/ch03-control}
\include{chapters/ch04-pipelining}
\include{chapters/ch05-cache}
\include{chapters/ch06-vm}
\include{chapters/ch07-io}
